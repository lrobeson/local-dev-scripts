...
cd /Users/ldavis-robeson/Google\ Drive/Local\ Dev/scripts && git add . && git add -u . && git commit -m "Automatic snapshot by Alfred. Yay, automation!" && git push origin master